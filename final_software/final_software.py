...
class TriplestoreDataProcessor (TriplestoreProcessor):
    ...
    #after having created our triples we can upload persistently the graph on our triplestore. We create an instance of the class
    #SPARQLUpdateStore that acts like a proxy to interact with the triplestore 
        from rdflib.plugins.stores.sparqlstore import SPARQLUpdateStore

        store = SPARQLUpdateStore()
        
    #The important thing is to open the connection with the store passing, as input,
    # a tuple of two strings with the same URLs, defining the SPARQL endpoint of the triplestore where to upload the data.
